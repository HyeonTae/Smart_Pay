		...
		<div class="form-panel one">
			<div class="form-header">
				...
				<center>
					<h2>상인 정보 조회</h2>
					<center>
						<form action="main.do?action=searchMerchantForID" method="post">
							<div class="form-group">
								<label for="username">상인 ID</label> <input type="text" name="id" />&nbsp;&nbsp;
								<button name="submit">검색</button>
							</div>
						</form>
			</div>
			<div class="form-content">
				<form action="main.do?action=updateMerchant" method="post">
					<%
						Merchant m = (Merchant) request.getAttribute("merchant");
						if (m != null) {
					%>
					<div class="form-group">
						<label for="username">상인 ID</label> <input type="text" id="id"
							name="id" value="<%=m.getM_id()%>" readonly="readonly" />
					</div>
					<div class="form-group">
						<label for="password">비밀번호</label> <input type="text" id="pass"
							name="pass" required="required" value="<%=m.getM_pass()%>" />
					</div>
					<div class="form-group">
						<label for="password">이름</label> <input type="text" name="name"
							required="required" value="<%=m.getM_name()%>" />
					</div>

					<div class="form-group">
						<label for="password">총금액</label> <input type="text" name="sum"
							required="required" value="<%=m.getM_sum()%>" />
					</div>
					<div class="form-group">
			...
			<div class="form-content">
				...
				<form action="main.do?action=deleteMerchant" method="post">
					<div class="form-group">
