	...
	<div class="form">
		...
		<div class="form-panel one">
			...
			<div class="form-content">
				<form action="main.do?action=addCustomerToAdmin" method="post"
					id="myForm">
					<div class="form-group">
						<label for="username">고객Id</label> <input type="text" id="id"
					...
					<div class="form-group">
						<label for="password">이름</label> <input type name="name"
							required="required" />
					</div>
					<div class="form-group">
						<label for="password">총금액</label> <input name="sum"
							required="required" />
					</div>
					<div class="form-group">
